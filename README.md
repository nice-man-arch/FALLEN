...
Fallan is a native Android music streaming app built with Kotlin and Jetpack Compose. It uses JioSaavn as its backend to search and stream music, with a feature set built to match — and in some cases, exceed — what's available on the platform itself.
...
- [ ] 🗂️ Split `FallenApp.kt` into separate composable files
